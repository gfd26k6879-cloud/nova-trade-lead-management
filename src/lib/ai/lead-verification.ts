...
export function buildLeadVerificationRequest(lead: Lead): Record<string, unknown> {
  ...
  return {
    ...
    tool_choice: "auto",
    instructions: [
      "You perform identity research for a local business and find possible official domains, phones, sources, and business matches.",
      ...
      "If only directory sources claim a domain, return the candidate URL and sources but prefer manual_review or prioritize over exclude.",
      "Do not recommend exclusion unless you found a real official website with at least one source URL.",
