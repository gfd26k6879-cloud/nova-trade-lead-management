  ...
  it.skipIf(process.env.G003_RUN_DISPOSABLE_PG_TESTS !== "1")(
    ...
    async () => {
      ...
      try {
        ...
        expect(full).toEqual({ discovered: 58, applied: 56, skipped: 2 });
        ...
        expect(baselineReceipt).toEqual({ discovered: 58, applied: 46, skipped: 2 });
  ...
  it.skipIf(process.env.G003_RUN_DISPOSABLE_PG_TESTS !== "1")(
    ...
    async () => {
      ...
      try {
        ...
        expect(baselineReceipt).toEqual({ discovered: 58, applied: 47, skipped: 2 });
  ...
  it.skipIf(process.env.G003_RUN_DISPOSABLE_PG_TESTS !== "1")(
    ...
    async () => {
      ...
      try {
        ...
        expect(baselineReceipt).toEqual({ discovered: 58, applied: 48, skipped: 2 });
  ...
  it.skipIf(process.env.G003_RUN_DISPOSABLE_PG_TESTS !== "1")(
    ...
    async () => {
      ...
      try {
        ...
        expect(baselineReceipt).toEqual({ discovered: 58, applied: 49, skipped: 2 });
