...
|---|---|---|---|---|
| Platform, Tenancy, and Security | `Nova Trade - Platform Tenancy Security` | `codex/nova-platform-tenancy` | `C:\Users\Masih\Documents\NovaTradeWorktrees\platform-tenancy` | G-006A source `7286bc6b2ee15cba2d19de0cd57b74c86f979fa2` is rejected; Terra-medium repair round 1 is active on the same four paths with no startup activation. |
...
| `G-006A` | Repair round 1 in progress | Terra-medium is repairing rollback escape, copyable/reusable capability, incomplete 37-table preservation, same-connection physical-schema trust, and the unpinned definition digest within the same four paths. |
